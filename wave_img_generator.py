...
def apply_blur_by_depth(canvas, focal_y, max_blur_radius):
    ...
    blur_amounts = np.clip(distance_after_focal ** 2 * max_blur_radius * 8, 0, max_blur_radius)
...
if __name__ == "__main__":
    ...
    canvas = apply_blur_by_depth(canvas, focal_y=0.69, max_blur_radius=int(30 * dpi /200))
